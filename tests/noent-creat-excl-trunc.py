...
# Open read-only
def subtest_1(ctx):
    """Create O_CREAT|O_EXCL|O_TRUNC|O_RDONLY"""
...
def subtest_2(ctx):
    """Create O_CREAT|O_EXCL|O_TRUNC|O_WRONLY"""
    f = ctx.no_file() + ctx.termslash()
...
def subtest_3(ctx):
    """Create O_CREAT|O_EXCL|O_TRUNC|O_APPEND|O_WRONLY"""
    f = ctx.no_file() + ctx.termslash()
...
def subtest_4(ctx):
    """Create O_CREAT|O_EXCL|O_TRUNC|O_RDWR"""
    f = ctx.no_file() + ctx.termslash()
...
def subtest_5(ctx):
    """Create O_CREAT|O_EXCL|O_TRUNC|O_APPEND|O_RDWR"""
    f = ctx.no_file() + ctx.termslash()
