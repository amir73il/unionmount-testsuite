...
def subtest_1(ctx):
    ...
    ctx.open_file(f, ro=1, crt=1, ex=1, tr=1, read=b"")
...
def subtest_2(ctx):
    ...
    ctx.open_file(f, wo=1, crt=1, ex=1, tr=1, write=b"q")
...
def subtest_3(ctx):
    ...
    ctx.open_file(f, app=1, crt=1, ex=1, tr=1, write=b"q")
    ctx.open_file(f, ro=1, read=b"q")
...
def subtest_4(ctx):
    ...
    ctx.open_file(f, rw=1, crt=1, ex=1, tr=1, write=b"q")
    ctx.open_file(f, ro=1, read=b"q")
...
def subtest_5(ctx):
    ...
    ctx.open_file(f, ro=1, app=1, crt=1, ex=1, tr=1, write=b"q")
    ctx.open_file(f, ro=1, read=b"q")
